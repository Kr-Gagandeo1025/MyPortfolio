  ...
  return (
    <div id="collab" className="flex justify-evenly items-center flex-col lg:flex-row h-screen border-t-2 p-4">
        <div className="flex flex-col lg:h-[70%]">
            ...
            <span className="text-xl lg:text-2xl lg:ml-12 mt-12 z-50 flex gap-4 items-center w-fit"><Mail/><a href="mailto:kumargagandeo9@gmail.com">kumargagandeo9@gmail.com</a></span>
        ...
        <div className='flex flex-col justify-between lg:justify-end lg:h-[70%]'>
            <h1 className='text-xl lg:text-5xl'>Resume</h1>
