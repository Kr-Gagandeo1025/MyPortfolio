...
const Hero = () => {
  ...
  return (<div className='flex flex-col justify-center items-center' id="home">
      ...
      <motion.div id='about' className="flex flex-col p-10 min-h-screen " transition={{delay:0.2,type:"tween"}}initial={{opacity:0,scale:0.5}} whileInView={{opacity:1,scale:1}} viewport={{root:scorllRef}}>
          ...
          <div className="flex flex-col p-2 gap-10 justify-end items-center lg:flex-row h-full">
              <Image src={"/profile-pic.jpg"} height={500} width={500} className="rounded-2xl h-54 w-48 lg:h-[650px] lg:w-[650px]" alt='profile-pic'/>
              <motion.p className="text-md lg:text-5xl" transition={{delay:0.5,type:"spring"}} initial={{x:100,opacity:0}} whileInView={{x:0,opacity:1}} viewport={{root:scorllRef}}>
